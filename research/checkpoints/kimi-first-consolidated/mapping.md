...
- E-005-05, E-005-06, E-C005-05, and E-C005-06 are Kimi-reported Verified but cite FP-002 alone. Original state is retained with independent status unverified. FP-002 contains uncertain names and group-specific ranks. The three C-042 leads are also field-only.
